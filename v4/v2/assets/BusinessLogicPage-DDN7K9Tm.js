import{aC as t}from"./mermaid.core-D5g4aQMe.js";import{m as s,H as r,s as d,t as a,v as i,w as o,O as g,p as l,q as c,y as f}from"./index-B5SRghhT.js";import{_ as p}from"./_plugin-vue_export-helper-DlAUqK2U.js";const m={class:"logic-page"},v={class:"logic-hero"},P=s({__name:"BusinessLogicPage",setup(h){return r(async()=>{t.initialize({startOnLoad:!1,theme:"base",securityLevel:"loose",themeVariables:{fontFamily:"inherit"}});try{await t.run({querySelector:".mermaid"})}catch{}}),(u,e)=>{const n=l("router-link");return c(),d("div",m,[a("header",v,[i(n,{to:"/",class:"back"},{default:o(()=>[...e[0]||(e[0]=[f("← 返回门户",-1)])]),_:1}),e[1]||(e[1]=a("h1",null,"业务逻辑总览 · 五类图",-1)),e[2]||(e[2]=a("p",null,"课程与营期域 V2 · 0829 口径：业务流程 / 状态机 / 激励触发 / 数据流转 / 系统上下文",-1))]),e[3]||(e[3]=g(`<section class="logic-card" data-v-f84e0a61><h2 data-v-f84e0a61>① 业务流程图 · 主闭环</h2><p class="desc" data-v-f84e0a61>课程创建 → 审核 → 发布 → 营期排课 → 报名（免审核）→ 开营学习 → 激励发放 → 完课 → 结营（不可逆）。</p><pre class="mermaid" data-v-f84e0a61>flowchart LR
