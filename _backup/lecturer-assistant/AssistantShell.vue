<template>
  <div class="app-assistant-shell" :class="{ 'no-tabbar': !showTabbar }">
...
const tabs = [
  ...
  { path: '/app/assistant/live',      icon: 'calendar',  label: '营期'   },
...
.app-assistant-shell.no-tabbar { padding-top: 0; padding-bottom: 0; }
