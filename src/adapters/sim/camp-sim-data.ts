...
export const SEED_CAMPS: Camp[] = [
  ...
  // ── 直播草稿营期（可编辑排课·授课类型为直播）──
  {
    ...
    commission_enabled: false, lecturer_rate: 0.6, assistant_rate: 0.2, platform_rate: 0.2,
    certificate_checkin_threshold: 0.8,
    main_lecturer_id: 'LECT-202608-00001', main_lecturer_name: '张三',
  ...
  { id: 'SCHEDULE-202608-00023', camp_id: 'CAMP-202608-00005', day_number: 3, sort_order: 1, schedule_type: 'summary', schedule_mode: 'live', course_id: 'COURSE-202608-00001', lesson_id: 'LESSON-202608-00003', live_session_id: null, unlock_time: dayAhead(9) + 11 * 3600, deadline: null, title: 'Day3 直播答疑 · 阶段总结与答疑', description: '晚间 19:00 开播', is_required: false, completion_criteria: '', points_reward: 20, growth_reward: 10, task_description: undefined, completed_count: 0, completion_rate: 0, created_at: dayAgo(1), updated_at: dayAgo(1) },
  {
