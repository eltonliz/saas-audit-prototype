...
import type {
  Camp, CampEnrollment, DailyCheckin, CourseSchedule,
...
export const SEED_CAMPS: Camp[] = [
  {
    ...
    store_id: 'STORE-001', store_name: '测试代理公司门店',
  ...
  // ── 直播草稿营期（可编辑排课·授课类型为直播）──
  {
    id: 'CAMP-202608-00005', camp_no: 'CAMP-202608-00005',
    title: '直播获客实战营', description: '直播模式·直播间获客与转化实战（草稿·可排课）',
    cover_url: '', series_id: 'SERIES-001', series_name: '高效学习系列',
    mode: 'live', allow_products: true,
    start_date: dStr(7), end_date: dStr(11), total_days: 5,
    price: 0, is_paid: false,
    certificate_checkin_threshold: 0.8,
    store_id: 'STORE-001', store_name: '测试代理公司门店',
    capacity: 300, enroll_deadline: dayAhead(6),
    enrolled_count: 0, approved_count: 0, joined_count: 0,
    course_count: 5, schedule_count: 3,
    daily_red_packet_mode: 'by_course',
    status: 'draft',
  ...
  {
    id: 'CAMP-202608-00006', camp_no: 'CAMP-202608-00006',
    title: '直播带练训练营', description: '直播模式·从零排课示例（草稿·暂无排课）',
    cover_url: '', series_id: 'SERIES-001', series_name: '高效学习系列',
    mode: 'live', allow_products: false,
    start_date: dStr(14), end_date: dStr(18), total_days: 5,
    price: 0, is_paid: false,
    certificate_checkin_threshold: 0.8,
    store_id: 'STORE-001', store_name: '测试代理公司门店',
    capacity: 120, enroll_deadline: dayAhead(13),
    enrolled_count: 0, approved_count: 0, joined_count: 0,
    course_count: 5, schedule_count: 0,
    daily_red_packet_mode: 'by_camp',
    status: 'draft',
    created_at: dayAgo(1), updated_at: dayAgo(1),
  },
  ...
  {
    id: 'CAMP-202608-00007', camp_no: 'CAMP-202608-00007',
    title: '时间管理训练营', description: '录播模式·时间管理实战（报名已截止·等待开营演示）',
    cover_url: '', series_id: 'SERIES-001', series_name: '高效学习系列',
    mode: 'recorded', allow_products: false,
    start_date: dStr(19), end_date: dStr(25), total_days: 7,
    price: 0, is_paid: false,
    certificate_checkin_threshold: 0.8,
    store_id: 'STORE-001', store_name: '测试代理公司门店',
    capacity: 60, enroll_deadline: dayAhead(-1),
    enrolled_count: 60, approved_count: 60, joined_count: 0,
    course_count: 4, schedule_count: 7,
    daily_red_packet_mode: 'by_course',
    status: 'enrolling',
    created_at: dayAgo(12), updated_at: dayAgo(2),
  },
  {
    id: 'CAMP-202608-00008', camp_no: 'CAMP-202608-00008',
    title: '职场写作训练营', description: '录播模式·职场写作进阶（已结束演示）',
    cover_url: '', series_id: 'SERIES-001', series_name: '高效学习系列',
    mode: 'recorded', allow_products: false,
    start_date: dStr(-20), end_date: dStr(-13), total_days: 7,
    price: 0, is_paid: false,
    certificate_checkin_threshold: 0.8,
    store_id: 'STORE-001', store_name: '测试代理公司门店',
    capacity: 100, enroll_deadline: dayAhead(-22),
    enrolled_count: 89, approved_count: 85, joined_count: 85,
    course_count: 4, schedule_count: 7,
    daily_red_packet_mode: 'by_camp',
    status: 'ended',
    created_at: dayAgo(30), updated_at: dayAgo(12),
  },
];

// ── 营期报名（ENT-CAMP-002·V2·0829：全免费直接报名，无邀请码/归属/订单）──
export const SEED_ENROLLMENTS: CampEnrollment[] = [
  { id: 'ENR-202608-00001', enrollment_no: 'ENR-202608-00001', camp_id: 'CAMP-202608-00001', camp_title: '7天高效学习营', student_id: 'STU-001', student_name: '王五', student_phone: '13800000001', channel: 'direct', group_id: 'CAMPGROUP-202608-00001', status: 'enrolled', reviewer_id: 'admin-001', review_remark: undefined, reviewed_at: dayAgo(8), enrolled_at: dayAgo(10), joined_at: dayAgo(7), created_at: dayAgo(10), updated_at: dayAgo(7) },
  { id: 'ENR-202608-00002', enrollment_no: 'ENR-202608-00002', camp_id: 'CAMP-202608-00001', camp_title: '7天高效学习营', student_id: 'STU-002', student_name: '赵六', student_phone: '13800000002', channel: 'direct', group_id: 'CAMPGROUP-202608-00001', status: 'enrolled', reviewer_id: 'admin-001', review_remark: undefined, reviewed_at: dayAgo(8), enrolled_at: dayAgo(9), joined_at: dayAgo(7), created_at: dayAgo(9), updated_at: dayAgo(7) },
  { id: 'ENR-202608-00003', enrollment_no: 'ENR-202608-00003', camp_id: 'CAMP-202608-00002', camp_title: '职场沟通训练营', student_id: 'STU-001', student_name: '王五', student_phone: '13800000001', channel: 'admin_assign', group_id: null, status: 'enrolled', reviewer_id: 'admin-001', review_remark: undefined, reviewed_at: dayAgo(2), enrolled_at: dayAgo(3), joined_at: null, created_at: dayAgo(3), updated_at: dayAgo(2) },
  { id: 'ENR-202608-00004', enrollment_no: 'ENR-202608-00004', camp_id: 'CAMP-202608-00001', camp_title: '7天高效学习营', student_id: 'STU-003', student_name: '钱七', student_phone: '13800000003', channel: 'direct', group_id: null, status: 'enrolled', reviewer_id: null, review_remark: undefined, reviewed_at: null, enrolled_at: dayAgo(1), joined_at: null, created_at: dayAgo(1), updated_at: dayAgo(1) },
  { id: 'ENR-202608-00005', enrollment_no: 'ENR-202608-00005', camp_id: 'CAMP-202608-00001', camp_title: '7天高效学习营', student_id: 'STU-003', student_name: '钱七', student_phone: '13800000003', channel: 'direct', group_id: 'CAMPGROUP-202608-00001', status: 'enrolled', reviewer_id: 'admin-001', review_remark: undefined, reviewed_at: dayAgo(6), enrolled_at: dayAgo(8), joined_at: dayAgo(6), created_at: dayAgo(8), updated_at: dayAgo(6) },
  { id: 'ENR-202608-00006', enrollment_no: 'ENR-202608-00006', camp_id: 'CAMP-202608-00001', camp_title: '7天高效学习营', student_id: 'STU-004', student_name: '孙八', student_phone: '13800000004', channel: 'direct', group_id: 'CAMPGROUP-202608-00001', status: 'enrolled', reviewer_id: 'admin-001', review_remark: undefined, reviewed_at: dayAgo(5), enrolled_at: dayAgo(7), joined_at: dayAgo(5), created_at: dayAgo(7), updated_at: dayAgo(5) },
  { id: 'ENR-202608-00007', enrollment_no: 'ENR-202608-00007', camp_id: 'CAMP-202608-00001', camp_title: '7天高效学习营', student_id: 'STU-005', student_name: '周九', student_phone: '13800000005', channel: 'direct', group_id: null, status: 'enrolled', reviewer_id: 'admin-001', review_remark: undefined, reviewed_at: dayAgo(4), enrolled_at: dayAgo(6), joined_at: dayAgo(4), created_at: dayAgo(6), updated_at: dayAgo(4) },
  { id: 'ENR-202608-00008', enrollment_no: 'ENR-202608-00008', camp_id: 'CAMP-202608-00001', camp_title: '7天高效学习营', student_id: 'STU-006', student_name: '吴十', student_phone: '13800000006', channel: 'admin_assign', group_id: null, status: 'enrolled', reviewer_id: 'admin-001', review_remark: undefined, reviewed_at: dayAgo(3), enrolled_at: dayAgo(5), joined_at: dayAgo(3), created_at: dayAgo(5), updated_at: dayAgo(3) },
  { id: 'ENR-202608-00009', enrollment_no: 'ENR-202608-00009', camp_id: 'CAMP-202608-00001', camp_title: '7天高效学习营', student_id: 'STU-007', student_name: '郑十一', student_phone: '13800000007', channel: 'direct', group_id: 'CAMPGROUP-202608-00001', status: 'enrolled', reviewer_id: 'admin-001', review_remark: undefined, reviewed_at: dayAgo(2), enrolled_at: dayAgo(4), joined_at: dayAgo(2), created_at: dayAgo(4), updated_at: dayAgo(2) },
];
...
// V2·0829 用户裁决：邀请码/口令体系下线，SEED_INVITE_CODES 已删除
...
export const SEED_SCHEDULES: CourseSchedule[] = [
  ...
  { id: 'SCHEDULE-202608-00021', camp_id: 'CAMP-202608-00005', day_number: 1, sort_order: 1, schedule_type: 'course', schedule_mode: 'live', course_id: 'COURSE-202608-00001', lesson_id: 'LESSON-202608-00001', live_session_id: null, unlock_time: dayAhead(7) + 11 * 3600, deadline: null, title: 'Day1 直播开营 · 高效学习方法概览', description: '晚间 19:00 开播', is_required: true, completion_criteria: '观看时长≥30分钟', points_reward: 0, growth_reward: 0, task_description: undefined, completed_count: 0, completion_rate: 0, created_at: dayAgo(1), updated_at: dayAgo(1) },
  { id: 'SCHEDULE-202608-00022', camp_id: 'CAMP-202608-00005', day_number: 2, sort_order: 1, schedule_type: 'course', schedule_mode: 'live', course_id: 'COURSE-202608-00001', lesson_id: 'LESSON-202608-00002', live_session_id: null, unlock_time: dayAhead(8) + 11 * 3600, deadline: null, title: 'Day2 直播课 · 记忆与专注力训练', description: '晚间 19:00 开播', is_required: true, completion_criteria: '观看时长≥30分钟', points_reward: 0, growth_reward: 0, task_description: undefined, completed_count: 0, completion_rate: 0, created_at: dayAgo(1), updated_at: dayAgo(1) },
  { id: 'SCHEDULE-202608-00023', camp_id: 'CAMP-202608-00005', day_number: 3, sort_order: 1, schedule_type: 'course', schedule_mode: 'live', course_id: 'COURSE-202608-00001', lesson_id: 'LESSON-202608-00003', live_session_id: null, unlock_time: dayAhead(9) + 11 * 3600, deadline: null, title: 'Day3 直播 · 阶段总结与回顾', description: '晚间 19:00 开播', is_required: false, completion_criteria: '', points_reward: 20, growth_reward: 10, task_description: undefined, completed_count: 0, completion_rate: 0, created_at: dayAgo(1), updated_at: dayAgo(1) },
  ...
  { id: 'SCHEDULE-202608-00002', camp_id: 'CAMP-202608-00001', day_number: 2, sort_order: 1, schedule_type: 'course', schedule_mode: 'live', course_id: 'COURSE-202608-00001', lesson_id: 'LESSON-202608-00004', live_session_id: null, unlock_time: dayAgo(4), deadline: null, title: '专注力训练', description: '专注力的识别与训练方法', is_required: true, completion_criteria: '完播率≥90%', points_reward: 0, growth_reward: 0, task_description: undefined, completed_count: 115, completion_rate: 0.96, created_at: dayAgo(15), updated_at: dayAgo(4) },
