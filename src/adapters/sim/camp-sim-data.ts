...
export const SEED_SCHEDULES: CourseSchedule[] = [
  ...
  { id: 'SCHEDULE-202608-00023', camp_id: 'CAMP-202608-00005', day_number: 3, sort_order: 1, schedule_type: 'course', schedule_mode: 'live', course_id: 'COURSE-202608-00001', lesson_id: 'LESSON-202608-00003', live_session_id: null, unlock_time: dayAhead(9) + 11 * 3600, deadline: null, title: 'Day3 直播答疑 · 阶段总结与答疑', description: '晚间 19:00 开播', is_required: false, completion_criteria: '', points_reward: 20, growth_reward: 10, task_description: undefined, completed_count: 0, completion_rate: 0, created_at: dayAgo(1), updated_at: dayAgo(1) },
