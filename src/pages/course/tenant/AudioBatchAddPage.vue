<template>
  <div class="batch-add-page">
    ...
    <div v-else class="form-main">
      ...
      <t-card :bordered="false" class="section">
        <div class="section-head"><span class="section-badge"><t-icon name="cart" /></span><div class="section-title-wrap"><h3 class="section-title">有效期</h3></div></div>
        <div class="field">
          <div class="field-label">有效期</div>
          <t-radio-group v-model="batchForm.validity_type" style="margin-right:12px"><t-radio value="long">长期有效</t-radio><t-radio value="custom">自定义时间</t-radio></t-radio-group>
...
const batchForm = ref({
  description: '',
  validity_type: 'long' as 'long' | 'custom', validity_custom_date: null as Date | null,
  forbid_seek: false, forbid_speed: false, watermark_horse: false, watermark_text: false,
  // V2·0829 用户裁决：售卖/会员/试听/上架/详情模式字段已删除
});
