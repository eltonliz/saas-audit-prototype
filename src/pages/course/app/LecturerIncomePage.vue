<template>
  <div class="page">
    ...
    <div v-if="myBills.length === 0" class="empty">暂无</div>
...
.summary-box { flex: 1; text-align: center; padding: 14px; background: linear-gradient(135deg, #722ED1, #1890FF); color: #fff; border-radius: 12px; }
.sum-num { font-size: 18px; font-weight: 700; }
.sum-label { font-size: 11px; opacity: 0.8; }
.withdraw-btn { width: 100%; padding: 12px; background: #722ED1; color: #fff; border: none; border-radius: 10px; font-size: 14px; font-weight: 600; margin-bottom: 16px; }
...
.bill-status.withdrawn { color: #722ED1; background: rgba(114,46,209,0.1); }
.bill-amount { font-size: 14px; font-weight: 600; color: #722ED1; margin-top: 4px; }
...
.sheet-ok { flex: 1; padding: 12px; background: #722ED1; color: #fff; border: none; border-radius: 10px; font-weight: 600; }
